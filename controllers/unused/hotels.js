...
const getAllHotels = (req, res) => {
  ...
  query.exec(async (err, data) => {
    ...
    return res
      .status(404)
      .send({ message: `No hotels registered yet so far.` });
  });
};
...
const getHotelsByState = (req, res) => {
  ...
  query.exec(async (err, data) => {
    ...
    return res
      .status(404)
      .send({ message: `No hotels registered for ${req.query.state}!` });
  });
};
...
const getHotelsByUser = (req, res) => {
  ...
  query.exec(async (err, data) => {
    ...
    return res
      .status(404)
      .send({ message: `No hotels registered by this user!` });
  });
};
...
hotelsRouter.post("/registerHotel", async (req, res) => {
  return registerHotel(req, res);
});

hotelsRouter.get("/hotel/all", async (req, res) => {
  return getAllHotels(req, res);
});

hotelsRouter.get("/hotel/state", async (req, res) => {
  return getHotelsByState(req, res);
});

hotelsRouter.get("/hotel/user", async (req, res) => {
  return getHotelsByUser(req, res);
});

hotelsRouter.get("/hotel", async (req, res) => {
  return getOnehotel(req, res);
});

hotelsRouter.post("/hotel", async (req, res) => {
  return editHotel(req, res);
});

hotelsRouter.delete("/hotel", async (req, res) => {
