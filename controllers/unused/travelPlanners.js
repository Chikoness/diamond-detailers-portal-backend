  ...
  query.exec(async (err, data) => {
    ...
    if (data) {
      ...
      if (saved) {
        ...
        return res
          .status(200)
          .send({ message: "Planner to" + req.body.destination + " created!" });
      }
    }
...
travelPlannersRouter.post("/writeplanner", async (req, res) => {
  return writePlanner(req, res);
});

travelPlannersRouter.get("/getPlanners", async (req, res) => {
  return getPlanners(req, res);
});

travelPlannersRouter.get("/planner", async (req, res) => {
  return getOnePlanner(req, res);
});

travelPlannersRouter.post("/planner", async (req, res) => {
  return editPlanner(req, res);
});

travelPlannersRouter.delete("/planner", async (req, res) => {
